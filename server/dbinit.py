...
def main():
  ...
  # Create table
  try:
    cur.execute("CREATE TABLE users(username VARCHAR PRIMARY KEY,password VARCHAR, salt VARCHAR,dA TEXT, t INTEGER, publicKey INTEGER,b INTEGER,P INTEGER,Q INTEGER,e INTEGER,x INTEGER,temp INTEGER,chapNonce TEXT)")
